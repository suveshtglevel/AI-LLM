  ...
  return (
    <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-2xl p-8 shadow-2xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-white/50">Start using AIOS in minutes</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <Button type="submit" variant="primary" className="w-full h-11" isLoading={register_mutation.isPending}>
      ...
      {register_mutation.isError && (
        ...
        >
          {(register_mutation.error as any)?.response?.data?.error?.message || 'Registration failed. Please try again.'}
        </motion.div>
      )}
