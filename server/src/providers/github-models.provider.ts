...
ProviderRegistry.register({
  ...
  isConfigured: !!env.GITHUB_MODELS_API_KEY,
  createInstance: () => new GitHubModelsProvider(env.GITHUB_MODELS_API_KEY),
});

export class GitHubModelsProvider extends BaseProvider {
  constructor(apiKey: string) {
    super('GitHub Models', apiKey, 'https://models.inference.ai.azure.com');
  }
