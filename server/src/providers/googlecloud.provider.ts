...
ProviderRegistry.register({
  ...
  apiKeyEnvVar: 'GOOGLECLOUD_API_KEY',
  isConfigured: !!env.GOOGLECLOUD_API_KEY,
  createInstance: () => new GoogleCloudProvider(env.GOOGLECLOUD_API_KEY),
});

export class GoogleCloudProvider extends BaseProvider {
  constructor(apiKey: string) {
    super('GoogleCloud', apiKey, 'https://us-central1-aiplatform.googleapis.com/v1');
  }
